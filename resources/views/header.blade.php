...
<head>
    <meta charset="utf-8">
    <title>D3 - Teknologi Informasi</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" prodi, d3 teknologi Informasi, polita, politeknik aisyiyah pontianak, pontianak="keywords">
    <meta content="" Sistem Informasi Program Studi D-3 Teknologi Informasi Politeknik Aisyiyah Pontianak="description">
            ...
            <div class="navbar-nav mx-auto bg-light pe-4 py-3 py-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light border-0 m-0">
                        <a href="about.php" class="dropdown-item">Tentang</a>
                        <a href="quote.php" class="dropdown-item">Struktur Prodi</a>
                        <a href="team.php" class="dropdown-item">Tim Prodi</a>
                        <a href="testimonial.php" class="dropdown-item">Fasilitas</a>
                        <a href="mitra.php" class="dropdown-item">Mitra Prodi</a>
                    </div>
                </div>
                ...
                <a href="unduh.php" class="nav-item nav-link">Unduh Dokumen</a>
            </div>
