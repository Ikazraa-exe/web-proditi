            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#" class="text-warning">Tentang</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button type="button" class="btn btn-success">
                            <a href="tentang_tambah.php" class="text-light">Tambah Data</a>
                        </button>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="example" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>2</td>
                                    <td>B</td>
                                    <td>Info ini dapat berubah setiap saat</td>
                                    <td>
